...
- [2026-04-30](devlog/2026-04-30.md) — Step 18n-18x: Auditus separated-source identity fusion selector, runtime fusion shadow ASR/speaker evidence, arbitrium + ledger telemetry, deterministic/strong-pending enrollment, and Mel rolling compaction; r2 replay restored 4/4 births, 10 stable hits, 0 wrong, 0 authority violations
