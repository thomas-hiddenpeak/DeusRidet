...
## 2026-04-18 — MossFormer2 原生 CUDA 重写：架构拆解与实现准备
...
## 2026-04-19 — GPTQ GEMM 优化轮次：4 个实验，1 个成功
...
## 2026-04-18 — Prefill 优化分析：接近硬件极限（88 ms, M=11）
...
## 2026-04-17 — Decode 算子融合 + INT4 Marlin Attention：113→89 ms/tok（提速 21%）
...
## 2026-04-16 — Marlin 优化：SMEM 精确分配 + 融合残差加 + Tile 配置调优
...
## 2025-07-02 — FP16 GEMM 内核优化：达到 cuBLAS 同等性能
...
## 2025-07-26 — 说话人识别优化：v14–v20b 实验
