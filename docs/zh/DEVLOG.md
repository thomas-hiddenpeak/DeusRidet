...
- [2026-04-30](devlog/2026-04-30.md) — Step 18n-18y：Auditus 分离源 identity fusion selector、runtime fusion shadow ASR/speaker evidence、arbitrium + ledger/canary telemetry、deterministic/strong-pending enrollment，以及 Mel rolling compaction；r2 replay 恢复 4/4 个 birth、0 stable wrong、0 authority violation
